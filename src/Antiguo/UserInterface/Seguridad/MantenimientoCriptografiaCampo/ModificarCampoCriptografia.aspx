<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="ModificarCampoCriptografia.aspx.cs" Inherits="UserInterface.Seguridad.MantenimientoCriptografiaCampo.ModificarCampoCriptografia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <span class="titulo">Modificar Campo Criptografía </span>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drlCampoLlave1" runat="server" AppendDataBoundItems="True"
                                    DataSourceID="dsCamposMensaje" DataTextField="CAM_NOMBRE" 
                                    DataValueField="CAM_CODIGO">
                                    <asp:ListItem Value="-1">Seleccionar Campo</asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <table style="margin: auto;" class="tabla_mantenimiento tabla">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvTipoLlave2" runat="server" ControlToValidate="drlTipoLlave2"
                                    ErrorMessage="Debe ingresar el Tipo Llave 2" InitialValue="-1" ValidationGroup="Grupo">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table style="margin: auto;" class="tabla_mantenimiento tabla">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvCampoLlave2" runat="server" ControlToValidate="drlCampoLlave2"
                                        ErrorMessage="Debe ingresar el Campo Llave 2" InitialValue="-1" ValidationGroup="Grupo">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table style="margin: auto;" class="tabla_mantenimiento tabla">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvLlaveFija2" runat="server" ControlToValidate="txtLlaveFija2"
                                        ErrorMessage="Debe ingresar la Llave Fija 2" ValidationGroup="Grupo">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <table style="margin: auto;" class="tabla_mantenimiento tabla">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drlOperacionLlave"
                                    ErrorMessage="Debe ingresar la Operación Llave" InitialValue="-1" ValidationGroup="Grupo">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center">
                            <asp:Button ID="btnAceptar" runat="server" Text="Aceptar" 
                                ValidationGroup="Grupo" onclick="btnAceptar_Click" />
