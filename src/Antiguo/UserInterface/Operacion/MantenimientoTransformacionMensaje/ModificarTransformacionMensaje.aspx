<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="ModificarTransformacionMensaje.aspx.cs" Inherits="UserInterface.Operacion.MantenimientoTransformacionMensaje.ModificarTransformacionMensaje" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <span class="titulo">Modificar Transformación Mensaje</span>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Button ID="btnNuevo" runat="server"
                    Text="Aceptar" ValidationGroup="Grupo1" onclick="btnNuevo_Click" />
