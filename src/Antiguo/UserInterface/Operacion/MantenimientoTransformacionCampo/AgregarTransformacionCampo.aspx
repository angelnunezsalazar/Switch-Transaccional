<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="AgregarTransformacionCampo.aspx.cs" Inherits="UserInterface.Operacion.MantenimientoTransformacionCampo.AgregarTransformacionCampo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <span class="titulo">Agregar Transformación Campo</span>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvClase" runat="server" ControlToValidate="txtClase"
                                    ErrorMessage="Debe ingresar el Nombre Clase" ValidationGroup="Grupo1" Display="Dynamic">*</asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvMetodo" runat="server" ControlToValidate="txtMetodo"
                                    ErrorMessage="Debe ingresar Nombre Método" ValidationGroup="Grupo1" Display="Dynamic">*</asp:RequiredFieldValidator>
