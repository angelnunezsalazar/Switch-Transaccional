<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="ModificarValidacionCampo.aspx.cs" Inherits="UserInterface.Mensajeria.MantenimientoGrupoValidacion.ModificarValidacionCampo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" style="width: 400px;">
        ...
        <tr>
            <td align="center">
                <span class="titulo">Modificar Regla de Validaci&oacute;n a Campo</span>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <table align="center" style="width: 400px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblDescripcion" CssClass="texto" runat="server" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCriterio" runat="server" AutoPostBack="True">
                                <asp:ListItem Selected="True" Value="2">Inclusión</asp:ListItem>
                                <asp:ListItem Value="3">Procedimiento</asp:ListItem>
                                <asp:ListItem Value="3">Compnente</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
