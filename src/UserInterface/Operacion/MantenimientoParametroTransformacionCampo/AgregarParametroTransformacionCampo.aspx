<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="AgregarParametroTransformacionCampo.aspx.cs" Inherits="UserInterface.Operacion.MantenimientoParametroTransformacionCampo.AgregarParametroTransformacionCampo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <span class="titulo">Agregar Parametro Campo</span>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center">
                            <asp:Button ID="btnAceptar" CommandName="Insert" runat="server" Text="Aceptar" ValidationGroup="Grupo"
