<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Principal.Master" AutoEventWireup="true"
    CodeBehind="ModificarCampoPlantilla.aspx.cs" Inherits="UserInterface.Mensajeria.MantenimientoCampoPlantilla.ModificarCampoPlantilla" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <span class="titulo">Modificar Campo Plantilla</span>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                ...
                <asp:FormView ID="frmCampoPlantilla" runat="server" DataSourceID="dsCampoPlantilla"
                    DefaultMode="Edit" DataKeyNames="CMP_CODIGO" HorizontalAlign="Center" OnItemUpdating="frmCampoPlantilla_ItemUpdating">
                    <EditItemTemplate>
                        <table class="tabla">
                            <tr>
                                <td class="columnaIzquierda">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="drlTipoDato" runat="server" DataSourceID="dsTipoDato" DataTextField="TDT_NOMBRE"
                                        DataValueField="TDT_CODIGO" AppendDataBoundItems="True" SelectedValue='<%# Eval("TIPO_DATO.TDT_CODIGO") %>'>
                            ...
                            <div id="divPosicionRelativa">
                                <table class="tabla">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPosicionRelativa" runat="server" MaxLength="3" Width="70px" Text='<%# Bind("CMP_POSICION_RELATIVA") %>' />
                            ...
                            <table class="tabla">
                                ...
                                <tr>
                                    <td colspan="2" style="text-align: center">
                                        <asp:Button ID="btnAgregar" runat="server" Text="Aceptar" CommandName="Update" ValidationGroup="Grupo" />
                ...
                <asp:ObjectDataSource ID="dsCampoPlantilla" runat="server" DataObjectTypeName="BusinessEntity.CAMPO_PLANTILLA"
                    OldValuesParameterFormatString="original_{0}" SelectMethod="obtenerCampoPlantilla"
                    TypeName="BusinessLayer.Mensajeria.CampoPlantillaBL" UpdateMethod="modificarCampoPlantilla"
                    OnUpdated="dsCampoPlantilla_Updated" OnUpdating="dsCampoPlantilla_Updating">
                    <SelectParameters>
                        <asp:QueryStringParameter DefaultValue="-1" Name="codigo" QueryStringField="CodigoCampoPlantilla"
                            Type="Int32" />
                    </SelectParameters>
                </asp:ObjectDataSource>
            </td>
